export const PATHS = new Map([
  ...
  ['/resources/moltbook/reconcile.mjs', ['text/javascript', 'application/javascript']],
  ['/resources/moltbook/reconcile.test.mjs', ['text/javascript', 'application/javascript']],
  ['/resources/moltbook/quickstart.md', ['text/markdown', 'text/plain']],
  ['/resources/moltbook/examples/timeout.json', ['application/json']],
  ['/resources/moltbook/examples/timeout.expected.json', ['application/json']],
]);
